        ...
        <div className="lg:order-first lg:row-span-2">
          ...
          <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
            ...
            <p>
              ...
              at the back of our yard while wearing my older sister's motorcycle helmet, counted down from three, and jumped —
              hoping the tree was tall enough that with just a bit of momentum I'd be able to get to orbit.
            </p>
            <p>
              I spent the next few summers indoors working on a rocket design, while I recovered from the multiple surgeries it
              took to fix my broken legs. It took nine iterations, but when I was 15 I sent my dad's Blackberry into orbit and was
            ...
            <p>
              ...
              assemble at home so that the next generation of kids really can make it to orbit — from the comfort of their own backyard.
            </p>
          </div>
        </div>
        <div className="lg:pl-20">
